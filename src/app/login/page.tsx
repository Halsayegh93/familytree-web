      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-6 md:p-8 space-y-5">
        ...
        {tab === "password" && (
          <form onSubmit={loginWithPassword} className="space-y-3">
            <div>
              <label className="block text-xs font-bold text-[#475569] mb-1">اسم المستخدم</label>
              <input
                type="text"
                value={username}
            ...
            <div>
              <label className="block text-xs font-bold text-[#475569] mb-1">كلمة السر</label>
              <input
                type="password"
                value={password}
  ...
  return (
    <button
      ...
      className={`flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg font-bold text-sm transition ${
        active
          ? "bg-white text-[#357DED] shadow-sm"
